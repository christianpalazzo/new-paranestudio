  ...
  return (
    <section id="trabajos" ref={sectionRef} className="relative min-h-screen overflow-hidden">
      <div className="pt-20 pb-8 px-6 max-w-7xl mx-auto">
        ...
        <p className="text-text-secondary text-lg mb-12">Algunos proyectos que nos enorgullecen</p>
      </div>
          ...
          >
            ...
            <div className="absolute inset-0 opacity-10">
              <div className="w-full h-full" style={{
                backgroundImage: "radial-gradient(circle, rgba(78,205,196,0.3) 1px, transparent 1px)",
                backgroundSize: "30px 30px",
              }} />
            </div>

            {/* Project number */}
            <div className="absolute top-6 right-8 text-8xl font-heading font-bold text-white/5">
              0{i + 1}
            </div>
